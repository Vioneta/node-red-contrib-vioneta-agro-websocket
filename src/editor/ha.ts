...
export enum NodeCategory {
    Config = 'config',
    HomeAssistant = 'vioneta_agro',
    HomeAssistantDeprecated = 'vioneta_agro_deprecated',
    HomeAssistantEntities = 'vioneta_agro_entities',
}
...
const alphaWarning = (id: number) => {
    const alert = $.parseHTML(`
            <div class="ui-state-error ha-alpha-box">
                ...
                <a
                    href="https://github.com/Vioneta/node-red-contrib-vioneta-agro-websocket/issues"
                    target="_blank"
                    rel="noreferrer"
                >
                    issues
                ...
                <a
                    href="https://github.com/Vioneta/node-red-contrib-vioneta-agro-websocket/discussions/${id}"
                    target="_blank"
                    rel="noreferrer"
                >
                    here
